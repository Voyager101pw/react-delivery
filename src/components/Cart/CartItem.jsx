  ...
  return (
    <div className="item cart__item">
      ...
      <div className="item__name-info">
        ...
        <div className="item__info">тонкое тесто, 26 см</div>
      </div>

      <div className="item__count">
        <div className="btn btn--outline btn--circle btn--negative" />
        <b>10</b>
        <div className="btn btn--outline btn--circle btn--positive" />
      </div>
